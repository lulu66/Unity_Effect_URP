...
#pragma exclude_renderers gles
		// _RCAS:FSR的upscalling方式需要的
#pragma multi_compile_local_fragment _ _POINT_SAMPLING _RCAS _GAUSSF_RGB _GAUSSF_YUV
...
#define DitheringOffset         _Dithering_Params.zw
	...
	half4 Frag(Varyings input) : SV_Target
	{
		...
		// (The input color data for this shader variant is always linearly encoded because RCAS requires it)
			...
			#endif
		// --------------GAUSSF START -----------------
		#elif (_GAUSSF_RGB  || _GAUSSF_YUV)  && SHADER_TARGET >= 45
