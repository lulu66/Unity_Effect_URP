...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class ShaderPreprocessor : IPreprocessShaders
    {
        ...
        // 如果是延迟渲染，保留所有shader，不是的话，就剔除StencilDeferred shader
        ...
        /// <summary>
        /// 输出信息：当前shader剩余变体的百分比；总的shader剩余变体百分比，剔除耗费时长
        /// </summary>
        /// <param name="shader"></param>
        /// <param name="snippetData"></param>
        /// <param name="logLevel"></param>
        /// <param name="prevVariantsCount"></param>
        /// <param name="currVariantsCount"></param>
        /// <param name="stripTimeMs"></param>
        ...
        /// <summary>
        /// 剔除不支持给定的shader feature的shader编译数据
        /// </summary>
        /// <param name="shader"></param>
        /// <param name="snippetData"></param>
        /// <param name="compilerDataList"></param>
        public void OnProcessShader(Shader shader, ShaderSnippetData snippetData, IList<ShaderCompilerData> compilerDataList)
        {
            ...
            for (int i = 0; i < inputShaderVariantCount;)
            {
                ...
                // 遍历目标平台支持的所有shader feature,如果shader的某个feature不得到支持，则剔除
                ...
                // 如果shader的某个volume feature得不到支持，则剔除
            ...
            // 等价于下面的写法：
            //if (compilerDataList is List<ShaderCompilerData>)
            //{
            //    List<ShaderCompilerData> inputDataList = (List<ShaderCompilerData>)compilerDataList;
            //}
    ...
    {
        /// <summary>
        /// 返回目标构建平台支持的所有Renderer的shader features
        /// </summary>
        ...
        {
            // 获取支持的shader features
            FetchAllSupportedFeatures();
            // 获取支持的volume features
            FetchAllSupportedFeaturesFromVolumes();
#if PROFILE_BUILD
        ...
        /// <summary>
        /// 获取激活的构建平台的urp资源中每个Renderer支持的shader features,返回s_SupportedFeaturesSet
        /// </summary>        
                ...
                if (rendererData != null)
                {
                    for (int rendererFeatureIndex = 0; rendererFeatureIndex < rendererData.rendererFeatures.Count; rendererFeatureIndex++)
                    {
                        ...
                        if (decal != null)
                        {
                            ...
                            // 如果Graphics settings没有选择剔除无用变体，shader feature保留所有decal相关特性
                            if (!s_stripUnusedVariants)
                            {
        ...
        /// <summary>
        /// 根据decal的法线重构质量选择shader feature
        /// </summary>
        /// <param name="normalBlend"></param>
        /// <returns></returns>
