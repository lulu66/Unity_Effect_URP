...
namespace UnityEngine.Rendering.Universal
{
    public partial class ScriptableRenderer
    {
        ...
        /// <param name="isRenderPassEnabled"></param>
        ...
        /// <summary>
        /// 收集RenderPass中所有subpass的color attachment和input attachment，组成AttachmentDescriptor列表及每个subpass对列表的引用列表
        /// </summary>
        /// <param name="renderPass"></param>
        /// <param name="cameraData"></param>
        /// <param name="needCustomCameraColorClear"></param>
