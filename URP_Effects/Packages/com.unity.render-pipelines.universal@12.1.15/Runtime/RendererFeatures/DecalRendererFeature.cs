...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class SharedDecalEntityManager : System.IDisposable
    {
        ...
        // 只允许实例化一次DecalEntityManager，并维护对Manager的引用次数
        private int m_ReferenceCounter;

        // 创建decal管理器并初始化decal，加入chunck列表
    ...
    internal class DecalRendererFeature : ScriptableRendererFeature
    {
        ...
        /// <summary>
        /// 返回decal的实现方式，根据渲染模式和硬件是否支持来确定
        /// </summary>
        /// <param name="isDeferred"></param>
        /// <param name="checkForInvalidTechniques"></param>
        /// <returns></returns>
