...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        /// <summary>
        /// 主要工作：1）根据设置开启Film_Gain效果和Dither效果；2）根据是否使用fsr，开启颜色转换；3）根据设置开启FXAA效果；4）根据管线设置是否开启upscalling及其方式，绘制upscalling texture；5）设置camera的rt
        /// </summary>
