...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderer : IDisposable
    {
        ...
        /// 将相机的渲染目标设置为传递进来的colorTarget和depthTarget
        /// </summary>
        ...
        /// 配置当前renderer需要的render passes，这个方法每个相机每帧都要调用一次
        /// </summary>
        ...
        /// 添加自定义render feature的render pass到当前renderer,并移出无效renderpass
        ...
        protected void AddRenderPasses(ref RenderingData renderingData)
        {
            ...
            // 禁用所有RenderPass的Native RenderPass
        ...
        // m_ActiveColorAttachments和m_CameraColorTarget的区别:m_ActiveColorAttachments:动态变化的，随不同renderPass变化而更新；m_CameraColorTarget:在整个相机渲染期间通常保持不变，是指向相机的主要颜色渲染目标
        ...
        /// <summary>
        /// 设置渲染目标(颜色rt引用和depth rt引用，并设置rt的数据处理方式)
        /// </summary>
        /// <param name="cmd"></param>
        ...
        /// <summary>
        /// 设置多渲染目标，渲染的rt不是一个，是一组了
        /// </summary>
        /// <param name="cmd"></param>
        /// <param name="colorAttachments"></param>
        /// <param name="depthAttachment"></param>
