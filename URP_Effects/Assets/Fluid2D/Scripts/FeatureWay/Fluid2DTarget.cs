...
namespace Fluid2D
{
    public class Fluid2DTarget : MonoBehaviour
    {
		...
		public void Splat(Transform fluidPlaneTransform, Vector4 rect)
        {
            ...
            //SplatMat.SetVector("_DensityNoiseParams", densityNoiseParam); // �ܶ�ͼ��tillingOffset
            //SplatMat.SetVector("_VelocityNoiseParams", velocityNoiseParam);
            SplatMat.SetTexture("_Velocity", velocityTexture);      // ������ٶ�ͼ
        }
        ...
        private Vector4 ProjectTarget(Transform fluidPlaneTransform, Vector3 targetPos, float projectSize)
        {
            ...
            // ͶӰ�����λ�õ�����ƽ���ϣ�ԭ����Ҫ�������λ��ͨ�����߼��ͶӰ������ƽ���ϣ�����������һ���򻯣���Ϊƽ����ˮƽ�ģ���ô����������ƽ���ͶӰ��ʵ���Լ򵥵Ľ�y=plane.y;
            ...
            // ����ԭ���Ǵ�������һ��������ƽ����µ�Ŀ��λ���Ҳ��һ�����ߣ�Ȼ��ͨ����ƽ�潻�㣬���һ���ཻλ�ã���ת��������ƽ��ֲ�����ϵ�У���Ŀ��λ�õ�ͶӰλ�ü���һ����������Ϊһ�����ʵ�ͶӰ��С������ֵ
            // ����򻯵���ֱ��ͨ����������scale����
